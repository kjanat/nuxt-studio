...
export interface ModuleOptions {
  ...
  git?: {
    ...
    /**
     * Whether to add `Co-authored-by: Nuxt Studio <noreply@nuxt.studio>` to every commit.
     * Set to `false` to opt out of Studio attribution in commit messages.
     * @default true
     */
  ...
  async setup(options, nuxt) {
    ...
    nuxt.options.runtimeConfig.public.studio = {
      ...
      git: {
        ...
        coAuthorCredits: options.git?.coAuthorCredits ?? true,
      },
